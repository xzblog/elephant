...
<a class="js-tongjip"  href="?u=http://www.360kan.com/dianshi/list.php?cat=all%26pageno=1" target="_self">全部</a>
<?php 
include 'list.php';
$page=$_GET['page'];
$page1=$_GET['page']+=1;
...
foreach ($cat as $kcat=>$vcat){
    $flname= $name[$kcat];
    $flid="?u=http://www.360kan.com/dianshi/list.php?cat=".$vcat.'%26pageno=1';
    echo "<a class='js-tongjip' href='$flid' target='_self' title='$flname'>$flname</a>";
}
$fenge=$_GET['u'];
//echo $fenge;
?>
...
?>
         ...
         <div class="paging"> <a href="<?php  $feng=$_GET['u']; $newstr = substr($feng,0,strlen($feng)-1); $newstr1=str_replace("&","%26","$newstr"); $hello = explode('=',$feng); $hello1=$hello[2]-1;$boss="?u=".$newstr1.$hello1;echo $boss;?>" target="_self">上一页</a>
         <a href="<?php  $feng=$_GET['u']; $newstr = substr($feng,0,strlen($feng)-1); $newstr1=str_replace("&","%26","$newstr"); $hello = explode('=',$feng); $hello1=$hello[2]+1;$boss="?u=".$newstr1.$hello1;echo $boss;?>" target="_self">下一页</a>
