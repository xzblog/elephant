...
<a href='?m=http://www.360kan.com/zongyi/list.php?cat=all%26pageno=1' target='_self' title='全部'>全部</a>
<?php
include 'list.php';
$page=$_GET['page'];
$page1=$_GET['page']+=1;
...
foreach ($zycat as $kcat=>$vcat){
    ...
    $flid="?m=http://www.360kan.com/zongyi/list.php?cat=".$vcat.'%26pageno=1';
    echo "<a href='$flid' target='_self' title='$flzyname'>$flzyname</a>";
